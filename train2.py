...
from network.model3_3 import ConDSeg3_3
...
if __name__ == "__main__":
    ...
    # pretrained_backbone = "/home/liuyameng/ConDSeg-main/run_files/Glas/stage2_Glas_None_lr0.0001_20251219-210328/checkpoint.pth"
    ...
    for name, param in model.named_parameters():
        if name.startswith('layer0') or name.startswith('vss0') or name.startswith('vss1') or name.startswith(
                'vss2') or name.startswith('vss3') or name.startswith('layer1') or name.startswith(
                'layer2') or name.startswith(
                'layer3'):
