...
from network.model10 import ConDSeg10
from network.model11 import ConDSeg11
from network.model13 import ConDSeg13
...
from network.model6 import ConDSeg6
from network.model7 import ConDSeg7
from network.model8 import ConDSeg8
from network.model9 import ConDSeg9
...
if __name__ == "__main__":
    ...
    # pretrained_backbone = "/home/liuyameng/ConDSeg-main/run_files/Glas/stage1_Glas_None_lr0.0001_20251219-190607/checkpoint.pth"
    ...
    for name, param in model.named_parameters():
        if name.startswith('layer0') or name.startswith('vss3') or name.startswith('layer1') or name.startswith('layer2') or name.startswith(
                'layer3'):
