...
class ConDSeg3_3(nn.Module):
    def __init__(self, H=256, W=256):
        ...
        self.vss0 = VSSAdapter(dim=64, out_dim=64)
        self.vss1 = VSSAdapter(dim=256, out_dim=256)
        self.vss2 = VSSAdapter(dim=512, out_dim=512)
        self.vss3 = VSSAdapter(dim=1024, out_dim=1024)
